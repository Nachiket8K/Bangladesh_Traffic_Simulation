...
class Infra(Agent):
    ...
    name : string
        name of infra component
        
    road_name : float
        name of road that infra component is on
...
class Bridge(Infra):
    ...
    total_delay_time: int 
        total time trucks waited at the bridge
        
    trucks_passed: int 
        total amount of trucks that arrived at the bridge
...
class Link(Infra):
    ...
    __________
    trucks_passed: int
        total amount of trucks that passed this link
...
class Sink(Infra):
    ...
    removed_traffic: int
        total trucks removed at this sink
    ...
...
class Source(Infra):
    ...
    generated_traffic: int
        total trucks created at this source
        
    waiting_times: int
        total waiting time of trucks from this source
        
    waiting_freqs: int
        total times trucks waited from this source
    ...
...
class Vehicle(Agent):
    ...
    time_waited: int
        total waiting time the truck encountered
        
    freq_waited: int
        how many times the truck has encountered a delay
