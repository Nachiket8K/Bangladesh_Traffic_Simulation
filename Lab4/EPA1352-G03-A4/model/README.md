...
* [batch_run.py](batch_run.py): Runs the different scenarios. Calls the model and saves it output in the data\experiments folder 

    This file was created by group 22.
