...
This page explains the **data foundation of the project** for readers who are new to the repository. It focuses on **Assignment 1 (`Lab 1/`)**, where the team inspected, cleaned, and prepared the infrastructure data that later assignments build on.
...
- the notebooks in `Lab 1/` apply a mix of **type conversion**, **missing-value filtering**, **duplicate resolution**, **visual inspection**, and **neighbor-based coordinate correction**,
- the cleaned outputs are then intended to support later work on network construction, simulation, and disruption analysis.

---

## Why Assignment 1 matters
...
Assignment 1 is where that foundation is established. The goal is not just to "load some files," but to answer questions such as:
...
The main source materials for this page are:
- `Lab 1/README.md`
- `Lab 1/TCVData.ipynb`
...
## Core files used in Assignment 1
...
Inside `Lab 1/data/`, the repository separates inputs from outputs:

- `Lab 1/data/raw/`
- `Lab 1/data/processed/`
...
The road-LRP spreadsheet `Roads_InfoAboutEachLRP.xlsx` is referenced heavily in the notebooks and report as a core road table, even though its exact storage location varies across materials.
...
The Assignment 1 report and notebooks make it clear that the data is usable, but not clean by default.
...
The purpose of Assignment 1 is not just to make prettier tables. It prepares inputs for the next phases of the project.
...
It is important to read the Assignment 1 cleaning as **useful but incomplete**.
...
Assignment 1 establishes the project’s data foundation.
