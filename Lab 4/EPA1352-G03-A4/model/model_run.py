from model import BangladeshModel, compute_average_driving, compute_worst_bridge, compute_worst_bridge_delay, compute_traffic
...
generated, removed, delay_time_abs, delay_time_rel, delay_freq_abs, delay_freq_rel, traffic_bridges, traffic_links = compute_traffic(sim_model)